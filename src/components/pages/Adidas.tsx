import image1 from '../../assets/AdiFOM_TRXN_Shoes_Black_IG7453_01_standard.webp'
import image2 from '../../assets/Superstar_XLG_Shoes_Black_IG9777_01_standard.webp'
import image3 from '../../assets/PostMove_Mid_Cloudfoam_Super_Lifestyle_Basketball_Mid_Classic_Shoes_Black_GY7163_01_standard.webp'
...
const adidasModel1 = image1
const adidasModel2 = image2
const adidasModel3 = image3
        ...
        <div>
            ...
            <div style={{display: 'flex', justifyContent: 'center'}}>
                {adidasArr.map((adidas) => (
                    <Link key={adidas.id} to={`/model/adidas/${adidas.id}`}>
                        <img
                        src = {adidas.picture}
                        alt = {adidas.model}
                        className = {s.img}
